...
Internal HR/TA system per `prd.md` (v1). Built module by module; **M0 (Foundation)** is implemented:
schema, constants, authentication, role-based access, staff management, the event log write helper,
and the Cloudinary file helpers that later modules consume.
